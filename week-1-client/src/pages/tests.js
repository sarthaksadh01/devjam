                    ...
                    <div className="container">
                        ...
                        <ul>
                            {this.state.filterTest.map((test,index)=>{
                                ...
                                <div className="row">
                                    <div className="col-md-10"><h4 className=" text-truncate text-dark text-topic"><a href={test.status==="draft"?`/edit-test/${test._id}`:undefined} className="text-truncate text-dark text-topic">{test.title}</a><span className="badge rounded text-white ml-1 badge-warning">{test.status}</span></h4></div>
