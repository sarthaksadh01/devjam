        ...
        <div class="container mb-5  ">
            ...
            <div class="row mt-3">
                ...
                <div class="col-md-12 mb-4 ">
                    {props.desc}
                    {/* The main deliverable for this week revolves around creating a testing system that enables the admin to create a test & publish it to specific students.
                    The students can login, take the test and their submissions will be autograded. <br /> <br />
                    A <span class="font-weight-bold details2">MEGA Bonus Challenge</span> is open & this can help push your team into the next round!
                    You'll need to create a course scheduler by setting the start date & time.
                    The admin can add videos, deliverables and test to the schedule on specific days. */}
                </div>
