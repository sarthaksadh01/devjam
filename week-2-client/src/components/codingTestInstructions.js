                    ...
                    <div className="card rounded shadow p-3 mb-5">
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-4  float-right mr-2" >
                                
                                    <p className="text-muted  mb-4 " style={{float:"right"}}> <span><i class="fa fa-check-circle mr-3 ml-0 " aria-hidden="true" style={{color: "green" , fontSize:"30px"}}></i></span>System is compatible for test</p>
                                    <button onClick={() => { props.startTest() }} className="mx-auto mt-1 btn w-100 btn-lg btn-success shadow">Start Test</button>
                                </div>
