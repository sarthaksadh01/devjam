                            ...
                            <div className="row">
                                <div className="col-7">
                                    ...
                                    <div className="row">
                                        ...
                                        <h4>General Instructions</h4><br />
                                        <p>Duration of the test is {props.test.isTimed ? props.test.testTiming : "NA"} Mins</p><br />
                                        <p>Test Consist of {codingQuestions(props.test)} Coding Questions</p><br />
                                        <p>Test Consist of {props.test.questions.length - codingQuestions(props.test)} Frontend  Questions</p>
